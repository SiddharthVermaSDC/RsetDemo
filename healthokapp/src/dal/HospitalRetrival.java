...
public class HospitalRetrival {
	...
	public static ArrayList<Hospital> responseHospital(String HospitalId) {
		...
		while(rs.next()){
			...
			hosptl.add(new model.Hospital(hospitalId,hospitalname,addressId,hasER,facilities,opdFees,bed,addressLine1,addressLine2,addressLine3,cityId,pincode,regDate,website,phonenumber,hasRadiology,hasDiagnistics,hasAmbulance,addmissionProcess));
			 
			 //hosptl.add(new model.Hospital(cityId, hospitalname,addressId, hasER, facilities, opdFees, bed, addressLine1, addressLine2, addressLine3, cityId, pincode, regDate, website, phonenumber, hasRadiology, hasDiagnistics, hasAmbulance, addmissionProcess));
		}
